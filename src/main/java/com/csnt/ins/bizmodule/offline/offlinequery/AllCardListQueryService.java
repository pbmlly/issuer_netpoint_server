 ...
 */
public class AllCardListQueryService implements IReceiveService {

    private Logger logger = LoggerFactory.getLogger(QueryVehicleService.class);

    private final String serviceName = "[1013所有渠道卡列表查询]";
    ...
    public Result entry(Map dataMap) {
        ...
        try {
            ...
            //查询数据库数据
            SqlPara sqlPara = DbUtil.getSqlPara("queryAllCardList", kv);
            //查询总条数
            SqlPara sqlSizePara = DbUtil.getSqlPara("queryAllCardSize", sizeKv);
