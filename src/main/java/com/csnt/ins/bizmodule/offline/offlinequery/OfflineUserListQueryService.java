 ...
 * @date 2019/6/27.
 */
public class OfflineUserListQueryService implements IReceiveService {
    Logger logger = LoggerFactory.getLogger(BaseInfoReceiveService.class);

    private String serviceName = "[1009用户列表查询]";
...
//            int endNum = (pageNo -1) * pageSize + pageSize;
            ...
            SqlPara sqlPara = DbUtil.getSqlPara("QueryOfflineListUserInfo",kv);
            SqlPara sqlCtPara = DbUtil.getSqlPara("QueryOfflineListUserInfoCt",ctkv);
