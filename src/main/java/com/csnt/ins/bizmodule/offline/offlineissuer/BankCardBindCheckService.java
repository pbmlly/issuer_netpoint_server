 ...
 * @author cml
 **/
public class BankCardBindCheckService implements IReceiveService {
    private Logger logger = LoggerFactory.getLogger(BankCardBindCheckService.class);

    private final String serverName = "[8802银行卡绑卡校验]";
    private final String TRAN_CODE = "9901";
...
//                return Result.sysError(serverName + resMap.get(""));
//            }
